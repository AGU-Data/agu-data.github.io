...
* Come see presentations on a range of topics to boost your career and technical skills, from using MyST Markdown, managing your physical samples data, and sharing your MATLAB code to writing your first README file. (Full presentation schedule is available at [this link](https://data.agu.org/OSDHD/) and full Help Desk schedule is available [here](https://docs.google.com/spreadsheets/d/1VexK0iHEbu5AWx5bJAxCLalxKgHrtWQ6ul0lPs6bNWc/edit#gid=0).) 
